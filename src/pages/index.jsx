    ...
    <div className="md:px-4 my-3 md:w-1/3 w-full z-2">
      <div className="rounded shadow-lg bg-white p-6 flex flex-col items-center justify-center">
        ...
        <div className="py-5">
          ...
          voluptates quas corrupti aperiam laborum nisi atque
        </div>
      </div>
    </div>
  )
